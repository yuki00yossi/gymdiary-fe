...
import { MySetDetailView } from "@/components/training/myset/myset-detail";
...
export default function MySetDetailPage() {
  ...
  return (
    <AnimatedPage>
      <div className="container mx-auto p-4 md:p-6">
        ...
        {!isLoading && !errors && myset && <MySetDetailView mySet={myset} />}
      </div>
    </AnimatedPage>
  );
}
